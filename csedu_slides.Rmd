...
- __Research Idea:__ students should receive objective and motivating feedback through a warning email   
...
- Over all systems information of __802__ individuals was collected
...
- Logit model was used to predict students probability to pass the exam based on the first 3 online tests
...
.font80[
- `r TextCite(my_bib, 'Arnold2012')` investigated the effect of the signal light system at the Purdue University and found a positive effect on student grades
