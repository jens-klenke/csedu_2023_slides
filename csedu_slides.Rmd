...
1. [Used Model: Regression Discounity Design (RDD)](#RDD)
...
- Compulsory for business and economics
  ...
  - Homework and 5 online tests on the e-assessment platform  [JACK](https://s3.paluno.uni-due.de/en/forschung/spalte1/e-learning-und-e-assessment)
...
- `r TextCite(my_bib, 'Iver2019')` could not find an effect from their early waning system in the ninth grade.
...
- Many studies analyzed the sytstem with questionnaires

.padding_left_2[`r circle_right` We try to measure the effect directly on students' performance]
...
- The running variable $W$ must not have a jump around the cutoff in the density function. 
...
- The warning may also lead weak students to postpone participation to a later semester
  - The cost to postone exams are in our program quiet low
...
- An automatic repeatedly feedback system could possibly have a greater impact on students motivation
  - A detailed recurring feedback could also used to guide students
