...
- Consider the following suitable RDD representation:
...
- RDD compares the individuals around the cutoff to estimate an effect
  - This design is called _sharp_ RDD as the treatment and control group are perfectly separated
...
---
# Fuzzy RDD
- With the _fuzzy_ design it is possible to analyse a treatment for a setting where the two groups are not perfectly separated
