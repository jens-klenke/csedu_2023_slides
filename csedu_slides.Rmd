...
<br>
<br>
- The Logit model was used to predict students' probability to pass the exam based on the first 3 online tests
...
- An automatic repeatedly feedback system could have a more significant impact on student's motivation
