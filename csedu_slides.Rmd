...
- __Research Idea:__ students should receive objective and motivating warning email   
...
- Logit model was used to predict students probability to pass the final exam based on the frist 3 online tests
...
.pull-right[
- Groups left and right of the cutoff 
- Local Average Treatment Effect (__LATE__)
]
...
- We employed the data-driven approach by `r Citet(my_bib, 'imbensoptimal2009')` to determine the bandwidth
...
- Many individuals are not included in the final analysis for several reasons
  ...
  - Students far away from the cutoff are not provding much information for the model
...
.font90[
- Angrist, J. D., Imbens, G., and Rubin, D. B. (1996). Identification of causal effects using instrumental variables. Journal of the American Statistical Association, 91(434):444–455. Publisher: Taylor & Francis.
- Huntington-Klein, N. (2022). The effect : an introduction to research design and causality. Chapman & Hall
book. CRC Press, Taylor & Francis Group, Boca Raton ; London ; New York, first edition edition.
- Imbens, G. and Kalyanaraman, K. (2009). Optimal bandwidth choice for the regression discontinuity estimator. National Bureau of Economic Research, 1(14726).
...
---
# Regression Discontinuity Design (RDD) II 
